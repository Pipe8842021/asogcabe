...
<head>
    ...
    <link rel="stylesheet" href="admin/css/style-correo.css">
...
<body>
    ...
    <form action="https://formsubmit.co/asogcabeweb@gmail.com" method="POST" />
        ...
        <input type="hidden" name="_next" value="http://localhost/asogcabe/contactos.php">
